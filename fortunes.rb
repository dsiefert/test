module Roguelike
	FORTUNES = [
		...
		"They say that Elves are fond of nudism.",
		"They say that Dwarves are fond of black metal.",
		"They say that Humans are fond of wine.",
		...
		"Don't bother looking for potions.",
		"Don't bother looking for books.",
		"Don't bother looking for magical herbs."
	]
end
